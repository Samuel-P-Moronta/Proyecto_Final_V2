...
public class SOAPController {
    ...
    public void aplicarRutas() {
        ...
        try {
            ...
            // Para acceder al wsdl en http://localhost:7000/ws/SOAPService?wsdl
            SOAPService soapWebServices = new SOAPService();
            Endpoint endpoint = Endpoint.create(soapWebServices);
